...
public class LicenseAgent {
    ...
    public LicenseAgent(com.vladsch.idea.multimarkdown.license.LicenseAgent other) {
        updateFrom(other);
    }
    ...
    public void updateFrom(com.vladsch.idea.multimarkdown.license.LicenseAgent other) {
    ...
    public boolean isValidActivation() {
        try {
            ...
            String activationJson = "{\"product_name\":\"idea-multimarkdown\",\"product_version\":\"2.1.1\",\"product_released_at\":\"2016-10-02\",\"agent_signature\":\"475f99b03f6ec213729d7f5d577c80aa\",\"host_name\":\"DESKTOP-66PADPG\",\"host_product\":\"IU-162.2032.8\",\"license_expires\":\"2036-10-25\",\"license_type\":\"license\",\"license_features\":1,\"feature_list\":{\"enhanced\":1,\"development\":2},\"activated_on\":\"2016-10-11\",\"activation_expires\":\"2036-10-25\"}";
    ...
    public boolean isActivationExpired() {
        ...
        if (activation != null) {
            if (product_version == null || !product_version.equals(MultiMarkdownPlugin.getProductVersion())
                    //|| !getHostName().equals(com.vladsch.idea.multimarkdown.license.LicenseRequest.getHostName())
